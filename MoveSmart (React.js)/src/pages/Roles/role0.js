...
import '../../Assets/Styles/Roles/role0.css'

const role0Card = ({ title, icon, data }) => (
  <div className="role0-card">
  ...
  return (
    <div className="role0">
      ...
      <div className="top-bar">
        ...
        <h1>Welcome, Mr. role0!</h1>
      </div>
    </div>
  );
};

export default role0;